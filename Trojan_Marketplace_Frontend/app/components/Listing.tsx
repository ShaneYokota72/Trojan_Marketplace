  ...
  return (
    <div className='w-10/12 flex flex justify between' key={index}>
        ...
        <div className='w-1/3 flex flex-col justify-center items-center gap-2'>
            <button className='border-1 border-gray-300 static w-2/3 rounded-xl border bg-gray-200 p-4 hover:bg-gray-300'>View Listing</button>
            <button className='border-1 border-gray-300 static w-2/3 rounded-xl border bg-gray-200 p-4 hover:bg-gray-300'>Edit Listing</button>
        </div>
